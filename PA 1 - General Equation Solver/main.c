...
int main(void)
{
	...
	/* All of the code below designated to each task and is a print function asking for a user imput and its assosiated scan function or the application of the user defined functions*/
	...
	printf("The force (in Newtons) of the object is %.2lf \n", force);
